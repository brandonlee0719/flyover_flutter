...
class _MainScreenState extends State<MainScreen> {
        ...
        bottomNavigationBar: Consumer<VpnProvider>(
          ...
          child: SafeArea(
            child: SizedBox(
              ...
              //   placementId: "498984975335393_498997148667509", //testid
              ...
              child: AppodealBanner(
                  ...
                  placement: "mainScreen_screen_bottom"),
            ),
          ),
        ),
        body: SnappingSheet(
  ...
  void refreshBottomAd() async {
    print('adodeal: destroing');

    await Appodeal.destroy(Appodeal.BANNER);
    print('adodeal: destroyed');

    var loaded = false;

    while (!loaded) {
      loaded = await Appodeal.isLoaded(Appodeal.BANNER);
      print('adodeal: loaded: $loaded');
